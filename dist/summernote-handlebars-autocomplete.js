...
var _selectionPreserver = __webpack_require__(333);
...
(function (factory) {
  if (true) {
    !(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(334)], __WEBPACK_AMD_DEFINE_FACTORY__ = (factory),
    ...
    handlebarsAutocomplete: function handlebarsAutocomplete(context) {
      ...
      this.events = {
        ...
        'summernote.keydown': function summernoteKeydown(_, event) {
          ...
          console.log('showingAutocomplete', _this.showingAutocomplete);
        ...
        'summernote.keyup': function summernoteKeyup(_, event) {
          ...
          if (_this.showingAutocomplete && ![DOWN_KEY_CODE, UP_KEY_CODE, ENTER_KEY_CODE].includes(event.keyCode)) {
            ...
            var _suggestions = _this.getSuggestions(trimmedWord);

            if (isPromise(_suggestions)) {
              _suggestions.then(function (result) {
